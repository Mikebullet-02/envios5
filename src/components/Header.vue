<template>
  <div class="w-screen sm:w-screen">
    <div
      class="bg-inherit py-5 px-6 sm:py-5 sm:px-16 md:py-5 lg:py-8 lg:px-20 xl:px-44 2xl:pb-16 text-start text-neutral-800"
    >
      <h1
        class="sm:mb-5 text-[#003368] text-3xl sm:text-3xl md:text-3xl lg:text-4xl xl:text-4xl 2xl:text-6xl font-bold blue:bg-neutral-700 sm:pl-[0px] md:pl-[30px] xl:ml-[10px] tracking-widest ease-in duration-500"
      >
        AHORRA HASTA 60% EN
      ...
      <div class="mx-auto max-w-[900px] ml-5 sm:ml-5 md:ml-20 lg:ml-14">
        <ul
          class="list-disc flex flex-col space-y-2 py-5 sm:pt-3 md:pt-3 pb-5 text-lg sm:text-xl md:text-2xl lg:text-2xl xl:text-2xl sm:mr-5 text-gray-800"
        >
