<template>
  <li
    class="hover:text-blue-600 mt-3 mb-3 font-regular sm:font-bold text-xl sm:text-xl md:text-xl lg:text-xl 2xl:text-2xl pl-5 sm:p-0 md:px-0 lg:px-4 text-left sm:text-center text-white md:text-[#003368] xl:text-[#003368]"
  >
